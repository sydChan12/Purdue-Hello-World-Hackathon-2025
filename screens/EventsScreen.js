...
const eventsData = [
  {
    id: '1',
    name: 'Purdue Football Game vs Illinois',
    date: '10/4/2025',
    time: '12:00 PM',
  ...
  {
    id: '2',
    name: 'Purdue Womens Basketball Game vs Fairleigh',
    date: '11/3/2025',
    time: '8:00 PM',
    location: 'Mackney Arena',
    parkingImpact: 'Grant Street Garage is known for heavy traffic during this time.',
  },
  {
    id: '3',
    name: 'Annunal Purdue Christmas Show',
    date: '12/6/2025',
    time: '8:00 PM',
  ...
  {
    id: '4',
    name: "Winter Commencement",
    date: '12/21/2025',
    time: '7:00 PM',
    location: 'Elliot Hall of Music',
    parkingImpact: 'Heavy congestion and lot closures, especially near Elliot Hall of Music.',
  },
];
